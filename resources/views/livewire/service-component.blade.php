<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <div class="mb-4">
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center"
            wire:click="$toggle('serviceModal')">
    ...
    <x-dialog-modal wire:model="serviceModal">
        ...
        <x-slot name="footer">
            <button wire:click="{{ !$service_id ? 'addService' : 'updateService' }}"
    ...
    <x-dialog-modal wire:model="confirmDeleteServiceModal">
        ...
        <x-slot name="footer">
            <button wire:click="deleteService({{ $service_id }})"
                class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6 mr-2">
            ...
            <button wire:click="$set('confirmDeleteServiceModal', false)"
                class="bg-gray-400 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded ml-4 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6 mr-2">
